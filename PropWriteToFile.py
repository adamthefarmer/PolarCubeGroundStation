...
with open("ConfigUpRADMotor", 'wb') as f:
    data = struct.pack('>iiiHB',
			*motorgains, rate, motmode)
    f.write(data)

with open("ConfigUpRADData", 'wb') as f:
...
maxFileSize = 5000
maxDownlinkSize = 30000

with open("ConfigUpFMG", 'wb') as f:
    data = struct.pack('>HL',
...
with open("ConfigUpACS", 'wb') as f:
  stpk = '>'+39*'d'+'L'+'d'+6*'b'+61*'d'+'L'+'dd'
  data = struct.pack(stpk,
    *SC_I,deadband,muThres,muBang,*SPaxis,*TXaxis,*SCIaxis,*SCIconstraint,*SCaxis,
    ST_weight,gyro_weight,dMRP,*ST_ROTM,mode_4_time,torquer_pwm_magnitude,torquer_x_alignment,
    torquer_y_alignment,torquer_z_alignment,torquer_x_scramble,torquer_y_scramble,torquer_z_scramble,
    *K_det,*P_det,*Ki_det,Km_det,*K_sun,*P_sun,*Ki_sun,Km_sun,*K_sci,*P_sci,*Ki_sci,Km_sci,RW_Scale_X,
    RW_Scale_Y,RW_Scale_Z,GYRO0SLOPECORRECTX,GYRO0BIASX,GYRO0SLOPECORRECTY,GYRO0BIASY,GYRO0SLOPECORRECTZ,GYRO0BIASZ,
    GYRO1SLOPECORRECTX,GYRO1BIASX,GYRO1SLOPECORRECTY,GYRO1BIASY,GYRO1SLOPECORRECTZ,GYRO1BIASZ,MAG0SLOPECORRECTX,MAG0BIASX,
    MAG0SLOPECORRECTY,MAG0BIASY,MAG0SLOPECORRECTZ,MAG0BIASZ,MAG1SLOPECORRECTX,MAG1BIASX,MAG1SLOPECORRECTY,MAG1BIASY,MAG1SLOPECORRECTZ,MAG1BIASZ,
    gyro0_weight,gyro1_weight,mag0_weight,mag1_weight,anti_windup_time,i_Genc,i_Scic)
  f.write(data)
'''
